  ...
  getPage() {
    ...
    <div class="settings_hd">
      <div class="settings_hd-menu pivot-menu">
        <button class="settings_hd-menu--btn btn pivot-menu--btn js-link-btn"
          data-link="/acconut/settings" data-link-page-num="6" data-action="goToPage" data-run-in-frame="true">Аккаунт</button>
        <button class="settings_hd-menu--btn btn pivot-menu--btn js-link-btn pivot-menu--btn-active" data-link="/acconut/settings"
