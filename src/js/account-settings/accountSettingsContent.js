        ...
        <div class="settings-acc-info-block_bd cnt-block_bd js-account-settings-public-data-form">
          ...
          <label class="settings-acc-info-label">
            ...
            <span class="label-dsc">Ваш профиль будет доступен по ссылке <a
                ...
                href="https://tedgent.org/ir_yasaviev">https://tedgent.org/ir_yasaviev</a></span>
          </label>
        </div>
      ...
      <div class="cnt-block">
        ...
        <div class="settings-acc-security-block_bd cnt-block_bd">
          ...
          <label class="settings-acc-security-label">
            ...
            <div class="inp_wr js-inp-wrapper" data-characters-limit="true" data-auto-hang-handler="true">
              <input class="inp js-inp js-account-settings-new-password-inp" name="newPassword" data-characters-max-limit-value="30" type="password">
              <div class="inp-error-mess">
                <div class="inp-error-mess--txt js-inp-error-txt"></div>
              </div>
            </div>
          ...
          <label class="settings-acc-security-label">
            ...
            <div class="inp_wr js-inp-wrapper" data-characters-limit="true" data-auto-hang-handler="true">
              <input class="inp js-inp js-account-settings-new-password-retry-inp" name="newPasswordRetry" data-characters-max-limit-value="30" type="password">
              <div class="inp-error-mess">
                <div class="inp-error-mess--txt js-inp-error-txt"></div>
              </div>
            </div>
